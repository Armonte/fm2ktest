...
**Downloads:**
  - [fm2k_v0.2.70-bleeding.zip](https://github.com/Armonte/fm2ktest/releases/download/v0.2.70-bleeding/fm2k_v0.2.70-bleeding.zip) (9.4 MB)
...
uploads now pause during matches + trickle (fixes netplay ping spike from log upload)

**Downloads:**
  - [fm2k_v0.2.67-bleeding.zip](https://github.com/Armonte/fm2ktest/releases/download/v0.2.67-bleeding/fm2k_v0.2.67-bleeding.zip) (9.3 MB)

---

## v0.2.66-bleeding — 2026-06-11

_Tag: [`v0.2.66-bleeding`](https://github.com/Armonte/fm2ktest/releases/tag/v0.2.66-bleeding)_

fix launcher freeze/unresponsiveness (uploads now drain off the UI thread)

**Downloads:**
  - [fm2k_v0.2.66-bleeding.zip](https://github.com/Armonte/fm2ktest/releases/download/v0.2.66-bleeding/fm2k_v0.2.66-bleeding.zip) (9.3 MB)
...
fix 95fps regression (gamepad re-scan hitch), accurate rollback counter, stranded crash/desync logs now upload

**Downloads:**
  - [fm2k_v0.2.64.zip](https://github.com/Armonte/fm2ktest/releases/download/v0.2.64/fm2k_v0.2.64.zip) (9.3 MB)
...
**Downloads:**
  - [fm2k_v0.2.62-bleeding.zip](https://github.com/Armonte/fm2ktest/releases/download/v0.2.62-bleeding/fm2k_v0.2.62-bleeding.zip) (9.3 MB)
